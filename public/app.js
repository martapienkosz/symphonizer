...
function mouseClicked() {
  let soundData = {
    ...
    b: random(2, 7),
    c: random(2, 7),
    x1: random(50, innerWidth - 50),
    y1: random(50, innerHeight - 50),
    x2: random(50, innerWidth - 50),
    y2: random(50, innerHeight - 50),
    x3: random(50, innerWidth - 50),
    y3: random(50, innerHeight - 50),
  };
